...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('role', ['user', 'admin'])->default('user'); // نقش کاربر
            $table->boolean('is_active')->default(true); // فعال/غیرفعال
            $table->decimal('rial_balance', 20, 2)->default(0); // موجودی ریالی
            $table->string('bank_account')->nullable(); // شماره حساب بانکی
